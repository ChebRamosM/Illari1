...
var lyricsData = [
  ...
  { text: "Escucho mi nombre en el corredor", time: 21 },
  ...
  { text: "Y es que aunque me disparen", time: 44 },
  { text: "Que no me comparen con fotos de ayer", time: 46},
  { text: "Quédate esta noche conmigo, mi amor", time: 50},
  { text: "Y cierra los ojos, entiende que yo", time: 55},

  { text: "Enciendo mis sueños", time: 59},
  { text: "Cuando a mi lado siento tu calor", time: 60},
